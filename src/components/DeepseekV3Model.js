...
import deepseekQuizData from '../data/models/deepseekv3/model.json';
...
export default function DeepseekV3Model() {
  ...
  // Load the DeepSeek-V3 model data
  useEffect(() => {
    const loadData = async () => {
      try {
        // Import SVG as a URL
        const svgUrl = (await import('../data/models/deepseekv3/diagram.svg')).default;
        ...
        setError('Failed to load DeepSeek-V3 model data.');
        setLoading(false);
      }
    };
    loadData();
  ...
  useEffect(() => {
    ...
    const styleId = 'deepseek-model-styles';
    ...
    return (
      <div className="max-w-7xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-lg p-6 text-center">
          <h1 className="text-3xl font-bold mb-4">Loading DeepSeek-V3 Model...</h1>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex-shrink-0">
        <h1 className="text-2xl font-bold">🎯 DeepSeek-V3 Model - Interactive Quiz</h1>
