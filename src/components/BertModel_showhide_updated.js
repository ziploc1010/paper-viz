...
export default function BertModel() {
  ...
  const [visibility, setVisibility] = useState({}); // Default will be set to show all
                        ...
                        <div key={index} className="bg-gray-50 rounded-lg p-6">
                          ...
                          <div className="relative">
                            <button 
                              ...
                              className="absolute top-2 right-2 text-sm text-blue-600 hover:text-blue-800 cursor-pointer z-10 bg-white px-2 py-1 rounded"
                            >
                              {visibility[eqKey] !== false ? 'Hide' : 'Show'}
                            </button>
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    <button 
                      ...
                      className="absolute top-2 right-2 text-sm text-blue-600 hover:text-blue-800 cursor-pointer z-10 bg-white px-2 py-1 rounded"
                    >
                      {visibility[`${selectedComponent}_init_code`] !== false ? 'Hide' : 'Show'}
                    </button>
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    <button 
                      ...
                      className="absolute top-2 right-2 text-sm text-blue-600 hover:text-blue-800 cursor-pointer z-10 bg-white px-2 py-1 rounded"
                    >
                      {visibility[`${selectedComponent}_forward_code`] !== false ? 'Hide' : 'Show'}
                    </button>
